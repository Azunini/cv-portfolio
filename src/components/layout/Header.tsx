...
export default function Header() {
  ...
  return (
    <>
      ...
      <button
        className="lg:hidden fixed top-5 left-[calc(100%-70px)] z-50 text-white bg-rose-900 p-3 rounded-full focus:outline-none h-14 w-14 
            ...
            <ul className="style-none text-gray-400 lg:text-[1.2rem] font-jost flex flex-col gap-12">
              {["home", "projects", "about", "contact"].map((item) => (
                ...
                >
                  ...
                  <a
                    href={`#${item}`}
                    className="block w-full h-full font-normal"
                  >
